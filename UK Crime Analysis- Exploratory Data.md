...
Work_statement.pdf   - work statement of the project
Eda report.pdf - report with all key findings and relevant analysis
Preprocessing.ipynb - pre-processing notebook of all the data to be analysed
Analysis.ipynb - analysis notebook of all charts explored with explanations
data - all data containing population data and police force data
map-data - containing jseon file for maps 
...
( if using anaconda must go on anaconda prompt and install modules there)
pip install folium
...
GitHub link------------------------------------------------------------------------------------------------------------------
https://github.com/adck872/crime_data_analysis

Trello board link------------------------------------------------------------------------------------------------------------
https://id.atlassian.com/invite/p/goal?id=_DAhMT48RRWDeMoiL0js5w